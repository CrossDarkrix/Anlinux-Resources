...
wget https://raw.githubusercontent.com/EXALAB/AnLinux-Resources/master/Scripts/DesktopEnvironment/Apt/LXQt/vncserver-start --no-check-certificate -P $HOME/../usr/bin/
wget https://raw.githubusercontent.com/EXALAB/AnLinux-Resources/master/Scripts/DesktopEnvironment/Apt/LXQt/vncserver-stop --no-check-certificate -P $HOME/../usr/bin/
