...
wget https://raw.githubusercontent.com/EXALAB/AnLinux-Resources/master/Scripts/DesktopEnvironment/Heavy/KDE/Yum/arm/vncserver-start --no-check-certificate -P $HOME/../usr/bin/
wget https://raw.githubusercontent.com/EXALAB/AnLinux-Resources/master/Scripts/DesktopEnvironment/Heavy/KDE/Yum/arm/vncserver-stop --no-check-certificate -P $HOME/../usr/bin/
